...
/* package batched-queue-0.1.0.0 */
#ifndef VERSION_batched_queue
#define VERSION_batched_queue "0.1.0.0"
#endif /* VERSION_batched_queue */
#ifndef MIN_VERSION_batched_queue
#define MIN_VERSION_batched_queue(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_batched_queue */
...
#define CURRENT_COMPONENT_ID "batched-queue-0.1.0.0-inplace-batched-queue"
